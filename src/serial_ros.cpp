...
std::queue<std_msgs::Float32MultiArray> floatQueue;
...
int main(int argc, char** argv) {
  ...
  // Publisher
  ros::Publisher serial_pub_f =
      n.advertise<std_msgs::Float32MultiArray>("Serial_pub_float", 1000);
  ros::Publisher serial_pub_i =
      n.advertise<std_msgs::Int32MultiArray>("Serial_pub_int", 1000);
  ros::Publisher serial_pub_c =
      n.advertise<std_msgs::String>("Serial_pub_string", 1000);

  // Subscriber
  ros::Subscriber serial_sub_f =
      n.subscribe("Serial_sub_float", 100, float_callback);
  ros::Subscriber serial_sub_i =
      n.subscribe("Serial_sub_int", 100, int_callback);
  ros::Subscriber serial_sub_c =
      n.subscribe("Serial_sub_string", 100, string_callback);
